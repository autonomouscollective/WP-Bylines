            ...
            foreach ( $byline_array as $author ) {
                ...
                if ( true == $disable_link || false == get_field('person_is_linked', 'person_'.$id ) ) {
                    ...
                    if ( !empty($person_twitter_handle) && is_singular( get_post_type() ) ) {
                        $output .= "<a href=\"https://twitter.com/intent/user?screen_name=".$person_twitter_handle."\"><img src=\"" .content_url(). "/plugins/wp-bylines/bird_blue_16.png\" class=\"twitter-bird\"></a>";
                    }
                }
